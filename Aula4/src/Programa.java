...
public class Programa {
	...
	static void cadastrarConta() {
		...
		System.out.println("Cliente "+novaConta.cliente.nome+" "+novaConta.cliente.sobrenome+" seja bem vindo ao "+bancoSelecionado.nome);
		System.out.println("Sua agência é a "+agencia.numero);
		System.out.println("Sua conta é a "+novaConta.numeroConta);
